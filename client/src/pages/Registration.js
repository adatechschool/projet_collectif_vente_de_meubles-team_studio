       ...
       <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
        ...
        <div className='bg-[#f2F2F2] text-[#151515] flex flex-col justify-center font-worksans'>
          <form className='max-w-[400px] w-full mx-auto p-4' method='post' action="" onSubmit={handleSubmit}>
            <div>
            <img className='ml-20 py-11 -mt-6' src='./loginImages/logologin.svg' alt='brand logo' width={190}/>
            </div>
            ...
            focus:invalid:border-red focus:invalid:ring-red' type="text" placeholder="Firstname" value={firstname} onChange={(e) => setFirstname(e.target.value)}/>
            </div>
             <div className='flex flex-col py-2'>
              <label className='text-[#6b6b6b]'>Lastname</label>
              <input className='border p-2 text-black focus:outline-none focus:border-black focus:ring-1 focus:ring-white
            disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none invalid:border-red invalid:text-red
            focus:invalid:border-red focus:invalid:ring-red' type="text" placeholder="Lastname" value={lastname} onChange={(e) => setLastname(e.target.value)}/>
            </div>
            <div className='flex flex-col py-2'>
              <label className='text-[#6b6b6b]'>Address</label>
              <input className='border p-2 text-black focus:outline-none focus:border-black focus:ring-1 focus:ring-white
            disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none invalid:border-red invalid:text-red
            focus:invalid:border-red focus:invalid:ring-red' type="text" placeholder="Address" value={address} onChange={(e) => setAddress(e.target.value)}/>
            </div>
            <div className='flex flex-col py-2'>
